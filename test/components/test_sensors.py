...
from waqd.components.sensor_base import TempSensor
...
def test_max_delta(base_fixture, target_mockup_fixture, capsys):
    ...
    text = captured.out
    assert temp_value.m_as(unit_reg().degC) == 40.5
