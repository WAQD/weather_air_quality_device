...
class ComponentRegistry:
    ...
    def website_websocket_connection(self) -> "WAQDDeviceClient":
        ...
        return self._create_component_instance(
            WAQDDeviceClient,
            (self._settings.get_string(USER_API_KEY), self._settings.get_string(MAC_ADDRESS)),
        )
    ...
    def _create_component_instance(
        self, class_ref: Type[T], args: Sequence = [], name_ref=None
    ) -> T:
