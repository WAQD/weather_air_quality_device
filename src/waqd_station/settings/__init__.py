...
# general
from waqd.settings import LANG, LANG_ENGLISH, LANG_GERMAN, LANG_HUNGARIAN
...
# saved sensor values
LAST_TEMP_C_OUTSIDE = "last_temp_outside_value"
...
__all__ = ["Settings", "LANG", "LANG_ENGLISH", "LANG_GERMAN", "LANG_HUNGARIAN"]
