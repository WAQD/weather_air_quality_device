                    ...
                    <div v-if="currentLocation"
                        ...
                        <div class="card-body p-0">
                            <iframe width="100%" height="400" frameborder="0" scrolling="no"
                                marginheight="0" marginwidth="0" :src="osmEmbedUrl"
                                style="border: 0;">
                            </iframe>
...
// Captured once per widget-triggered navigation rather than bound directly to
// route.query, so clearing the query params afterwards doesn't reset the selected day.
const widgetForecastDay = ref(parseDayQuery(route.query.day) ?? 0)

// Strip the widget-only query params once they've been consumed, so a stale
// URL doesn't cause the forecast to auto-scroll again on the next normal visit.
