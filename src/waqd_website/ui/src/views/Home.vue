<template>
  <div>
    <!-- Main Hero Section -->
    <div class="hero hero-bg-main min-h-screen">
      <div class="hero-overlay bg-opacity-60"></div>
      <div class="hero-content flex-col max-w-4xl w-full relative z-10">
        <!-- Logged In View -->
        <div v-if="isLoggedIn" class="text-center glass rounded-box p-8 bg-primary/80 backdrop-blur-sm">
        ...
        <div v-else class="text-center glass rounded-box p-8 bg-primary/80 backdrop-blur-sm">
          ...
          <p class="py-6 text-lg">
            Create a professional indoor weather and air quality monitoring station with Raspberry Pi
          </p>
    ...
    <div class="hero hero-bg-features min-h-screen">
      <div class="hero-overlay bg-opacity-70"></div>
      <div class="hero-content flex-col lg:flex-row-reverse max-w-6xl w-full gap-8 relative z-10">
        <div class="lg:w-1/2 flex justify-center">
          <img :src="mainGuiImg" alt="WAQD Main Interface" class="rounded-lg shadow-2xl max-w-screen-md w-full" />
        </div>
        <div class="lg:w-1/2 glass rounded-box p-8 bg-base-100/90 backdrop-blur-sm">
          <h2 class="text-4xl font-bold mb-6">Full-Featured Display</h2>
    ...
    <div class="hero hero-bg-hardware min-h-screen">
      <div class="hero-overlay bg-opacity-70"></div>
      <div class="hero-content flex-col lg:flex-row max-w-6xl w-full gap-8 relative z-10">
        <div class="lg:w-1/2 flex justify-center">
          <img :src="waqdStationImg" alt="WAQD Station" class="rounded-lg shadow-2xl max-w-md w-full" />
        </div>
        <div class="lg:w-1/2 glass rounded-box p-8 bg-base-100/90 backdrop-blur-sm">
          <h2 class="text-4xl font-bold mb-6">Easy Assembly</h2>
          <p class="text-lg mb-4">
            Built with readily available components and a recommended case design for clean cable management.
          </p>
          <div class="space-y-3">
            <div class="collapse collapse-arrow bg-base-200">
              <input type="checkbox" />
              <div class="collapse-title text-xl font-medium">Raspberry Pi</div>
              <div class="collapse-content">
                <p>All versions supporting ARMv7 64-bit</p>
              </div>
            </div>
            <div class="collapse collapse-arrow bg-base-200">
              <input type="checkbox" />
              <div class="collapse-title text-xl font-medium">Display</div>
              <div class="collapse-content">
                <p>Raspberry Pi 7" touchscreen or Waveshare 5" display</p>
              </div>
            </div>
            <div class="collapse collapse-arrow bg-base-200">
              <input type="checkbox" />
              <div class="collapse-title text-xl font-medium">Sensors</div>
              <div class="collapse-content">
                <ul class="list-disc list-inside space-y-1">
                  <li>BME280/BMP280 - Temperature, Humidity, Pressure</li>
                  <li>MH-Z19 - NDIR CO2 sensor (highly accurate)</li>
                  <li>CCS811 - TVOC and eCO2</li>
                  <li>DHT22 - Budget temperature/humidity option</li>
                  <li>PIR501 - Motion detection</li>
                </ul>
              </div>
            </div>
            <div class="collapse collapse-arrow bg-base-200">
              <input type="checkbox" />
              <div class="collapse-title text-xl font-medium">Case</div>
              <div class="collapse-content">
                <p>SmartiPi Touch 2 recommended - supports all RPi versions with excellent cable management</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="hero hero-bg-3dprint min-h-screen">
      <div class="hero-overlay bg-opacity-70"></div>
      <div class="hero-content flex-col lg:flex-row-reverse max-w-6xl w-full gap-8 relative z-10">
        <div class="lg:w-1/2 flex justify-center">
          <img :src="sensorCaseImg" alt="3D Printable Sensor Case" class="rounded-lg shadow-2xl max-w-md w-full" />
        </div>
        <div class="lg:w-1/2 glass rounded-box p-8 bg-base-100/90 backdrop-blur-sm">
          <h2 class="text-4xl font-bold mb-6">3D Printable Sensor Case</h2>
          <p class="text-lg mb-4">
            Custom designed sensor housing that mounts perfectly on the back of the SmartiPi Touch 2 case.
          </p>
    ...
    <div class="hero hero-bg-custom min-h-screen">
      <div class="hero-overlay bg-opacity-70"></div>
      <div class="hero-content flex-col lg:flex-row max-w-6xl w-full gap-8 relative z-10">
        <div class="lg:w-1/2 flex justify-center">
          <img :src="optionsImg" alt="WAQD Options" class="rounded-lg shadow-2xl max-w-screen-md w-full" />
        </div>
        <div class="lg:w-1/2 glass rounded-box p-8 bg-base-100/90 backdrop-blur-sm">
          <h2 class="text-4xl font-bold mb-6">Fully Customizable</h2>
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="card bg-base-200 shadow-xl">
              <div class="card-body p-4">
                <h3 class="card-title text-lg">🎨 Display</h3>
                <p class="text-sm">Brightness, sleep mode, themes</p>
              </div>
            </div>
            <div class="card bg-base-200 shadow-xl">
              <div class="card-body p-4">
                <h3 class="card-title text-lg">🌐 Language</h3>
                <p class="text-sm">Multiple language support</p>
              </div>
            </div>
            <div class="card bg-base-200 shadow-xl">
              <div class="card-body p-4">
                <h3 class="card-title text-lg">☁️ Weather</h3>
    ...
    <div class="hero hero-bg-cta min-h-[60vh]">
      <div class="hero-overlay bg-opacity-60"></div>
      <div class="hero-content text-center max-w-4xl relative z-10">
        <div class="glass rounded-box p-12 bg-primary/80 backdrop-blur-sm">
          ...
          <p class="text-xl mb-8">
            Join the community and create your own professional weather station
          </p>
