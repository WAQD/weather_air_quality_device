    ...
    <div class="scroll-container">
        <div class="hero hero-bg-main min-h-screen snap-section relative">
            ...
            <div class="hero-content flex-col max-w-7xl w-full px-4 sm:px-6 lg:px-8 relative z-10">
                <div v-if="isLoggedIn"
                    class="grid w-full gap-4 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)] lg:gap-6">
                    <div
                        class="glass rounded-box p-4 sm:p-6 lg:p-8 bg-primary/80 backdrop-blur-sm max-w-full text-center lg:text-left">
                    ...
                    <div
                        class="glass rounded-box p-4 sm:p-6 bg-base-100/90 backdrop-blur-sm max-w-full text-base-content shadow-2xl">
            ...
            <div v-if="!isLoggedIn"
                class="absolute bottom-16 left-1/2 transform -translate-x-1/2 z-10 animate-bounce">
