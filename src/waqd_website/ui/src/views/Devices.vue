    ...
    <div v-else class="space-y-6">
      ...
      <div v-if="devices.length === 0" class="card bg-base-200 shadow-xl">
        <div class="card-body items-center text-center py-16">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-base-content opacity-30 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <dialog ref="pairingModal" class="modal">
      <div class="modal-box max-w-2xl">
        ...
        <div v-if="pairingState === 'input'" class="space-y-4">
          <div class="form-control">
            ...
            <input
              ...
              maxlength="6"
              @input="passphrase = passphrase.toUpperCase()"
            />
            <label class="label">
          ...
          <div v-if="qrCodeData" class="flex flex-col items-center gap-2 bg-base-200 p-4 rounded-box">
        ...
        <div v-else-if="pairingState === 'error'" class="space-y-4">
          <div class="flex flex-col items-center gap-4 py-8">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-error" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
async function claimDevice() {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      throw new Error(errorData.detail || errorData.message || 'Failed to claim device')
    }
  ...
  pollingInterval = window.setInterval(async () => {
    ...
    try {
      ...
      if (data.status === 'approved') {
        ...
        setTimeout(() => {
          closePairingModal()
          showToast('success', t('device_paired_successfully') || 'Device paired successfully!')
        }, 2000)
...
async function deleteDevice() {
  ...
  try {
    ...
    showToast('success', t('device_deleted_successfully') || 'Device deleted successfully')
    closeDeleteModal()
  } catch (error) {
