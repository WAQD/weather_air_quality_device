      ...
      <div class="hero-content flex-col max-w-7xl w-full px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div
          ...
          <div
            ...
            <div class="mt-2">
              <DeviceCard v-if="homeDevice" :device="homeDevice" :show-management-actions="false"
                @connect="connectToDevice" />
              <router-link v-else to="/rest/devices" class="btn btn-secondary btn-md sm:btn-lg">
            ...
            <div v-if="currentWeather" class="mt-5 space-y-4">
              ...
              <div class="flex flex-col gap-3 sm:flex-row">
                <button class="btn btn-secondary" type="button"
                  :disabled="isLoadingWeather || !homeLocation" @click="refreshWeather(true)">
